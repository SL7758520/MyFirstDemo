...
import com.feicuiedu.demotreasure.commons.IconSelectWindow;
...
//           String path= Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"crop_cache_file.jpg";
            File file = new File(uri.getPath());
            // 执行头像上传业务,nizhegeurishi nagenichuande
